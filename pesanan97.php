...
echo "<script>window.location.href='print.php?id=$new_pesanan_id&id_toko=$id_toko';</script>";
exit();
...
<form id="mainForm" method="POST" action="pesanan.php?nomeja=<?php echo $_GET["nomeja"]; ?>">
    <div class="form-group">
        <strong>NOMOR PESANAN:</strong> <?php echo $new_pesanan_id; ?>
...
<?php } else { ?>
    ...
    <?php
    // Mengambil IDTOKO pengguna
    $id_toko = $user_data['IDTOKO'];
