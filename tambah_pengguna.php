...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $check_query = "SELECT COUNT(*) as count FROM eat_and_go_pengguna WHERE username = ?";
    ...
    if ($count > 0) {
        ...
        $sql = "INSERT INTO eat_and_go_pengguna (username, nama, password) VALUES (?, ?, ?)";
...
<head>
    ...
    <link rel="shortcut icon" href="tambahpengguna.svg" type="image/svg+xml"> 
